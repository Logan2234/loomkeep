...
- `create_changelog` (or duplicate + `update_changelog`) with title `Loomkeep X.Y.Z`, body: one
  intro sentence + New/Improvements/Fixes sections, in plain user language — translate the
  CHANGELOG.md bullets, don't just copy them verbatim.
